...
class ObjetivoAprendizaje(models.Model):
    id=models.AutoField(primary_key=True)
    asignatura=models.ForeignKey(Asignaturas,null=True, on_delete=models.SET_NULL)
...
class Salas(models.Model):
    ...
    nombre= models.CharField(max_length=100)
    orden=models.IntegerField(blank=True,null=True)
    responsable=models.ForeignKey(Usuario,null=True,on_delete=models.SET_NULL)
...
class SalasPedidas(models.Model):
    ...
    oa=models.ForeignKey(ObjetivoAprendizaje,null=True,on_delete=models.SET_NULL)
...
class MatriculaAlumno(models.Model):
    ...
    entramite=models.IntegerField(null=True)
    tienejunaeb=models.CharField(max_length=200,blank=True,null=True)
    niveljunaeb=models.IntegerField(blank=True,null=True,default=0) #0= no tiene, 1=solo desayuno, 2=solo almuerzo, 3=desayuno y almuerzo
    #parte del alumno
    ...
    diasasistidos1=models.IntegerField(blank=True,null=True,default=0)
    diasasistidos2=models.IntegerField(blank=True,null=True,default=0)
    diasasistidos3=models.IntegerField(blank=True,null=True,default=0)
    diasasistidos4=models.IntegerField(blank=True,null=True,default=0)
...
class HistorialJunaeb(models.Model):
    id=models.AutoField(primary_key=True)
    alumno=models.ForeignKey(MatriculaAlumno,on_delete=models.CASCADE)
    ncomida=models.IntegerField() #1 desayuno, 2 almuerzo
    fecha=models.DateTimeField(blank=True,null=True)
...
class LibrosCra(models.Model):
    ...
    yearedicion=models.TextField(blank=True,null=True)
    isbn=models.TextField(blank=True,null=True)
    cursodestinado=models.TextField(blank=True,null=True)
    cantidad=models.IntegerField(blank=True,null=True)
    limitecantidad=models.IntegerField(blank=True,null=True)
    imagen=models.ImageField(blank=True,null=True)
    descripcion=models.TextField(blank=True,null=True)
...
class RegistroPublico(models.Model):
    ...
    matricula=models.ForeignKey(MatriculaAlumno,on_delete=models.SET_NULL,null=True)


class AsistenciaDocente(models.Model):
    id=models.AutoField(primary_key=True)
    iddocente=models.ForeignKey(Usuario,on_delete=models.CASCADE)
    year=models.IntegerField()
...
class ConfiguracionAdministrativa(models.Model):
    ...
    horadeatraso=models.TimeField(blank=True,null=True)

    iniciodeasistencia=models.ForeignKey(Calendario,related_name="iniciodeasistencia",blank=True,null=True,on_delete=models.SET_NULL)
    
    finals1=models.ForeignKey(Calendario,related_name="finals1",blank=True,null=True,on_delete=models.SET_NULL)
    cantidad1=models.IntegerField(blank=True,null=True)

    finals2=models.ForeignKey(Calendario,related_name="finals2",blank=True,null=True,on_delete=models.SET_NULL)
    cantidad2=models.IntegerField(blank=True,null=True)

    finals3=models.ForeignKey(Calendario,related_name="finals3",blank=True,null=True,on_delete=models.SET_NULL)
    cantidad3=models.IntegerField(blank=True,null=True)

    finals4=models.ForeignKey(Calendario,related_name="finals4",blank=True,null=True,on_delete=models.SET_NULL)
    cantidad4=models.IntegerField(blank=True,null=True)


    iniciodelistadeespera=models.IntegerField(default=1)
    listaesperaactivo=models.IntegerField(default=1)




class CajaIngrediente(models.Model):
    id=models.AutoField(primary_key=True)
    nombre=models.CharField(max_length=100)
    precio=models.IntegerField(default=0)

class CajaCategoria(models.Model):
    id=models.AutoField(primary_key=True)
    nombre=models.CharField(max_length=100)
...
class CajaIngredientesProducto(models.Model):
    id=models.AutoField(primary_key=True)
    producto=models.ForeignKey(CajaProducto,on_delete=models.CASCADE)
    ingrediente=models.ForeignKey(CajaIngrediente,on_delete=models.CASCADE)
    cantidad_ingrediente=models.IntegerField(default=0)

class CajaVenta(models.Model):
    id=models.AutoField(primary_key=True)
...
class CajaDetalle(models.Model):
    id=models.AutoField(primary_key=True)
    id_venta=models.ForeignKey(CajaVenta,on_delete=models.CASCADE)
    id_producto=models.ForeignKey(CajaProducto,on_delete=models.CASCADE)
