class javaadminpedidos{
        ...
        let html=`
            ...
            ${this.productos.map(dat=>{
                ...
                if($("#SelectBuscador").val()==1){
                    if(dat.nombrelibro.toLowerCase().includes($("#Buscador").val().toLowerCase())){
                    ...
                    if(dat.idhuella.nombre.toLowerCase().includes($("#Buscador").val())){
                ...
                return `
                    <tr>
                        ...
                        <td><button class="BotonSmall" onclick="adminpedidos.abririmagen('${dat.imagen}')">img</button></td>
                        <td>${dat.codigobarra}</td>
                        <td><button class="BotonAzul" onclick="adminpedidos.productoentregado(2,${dat.id})">Entregado</button><button class="BotonRojo" onclick="adminpedidos.productoentregado(3,${dat.id})">Devuelto</button></td>
    ...
    abririmagen(x){
        ...
        <button id="Cerrar" onclick="adminpedidos.cerrarventana()">X</button>
