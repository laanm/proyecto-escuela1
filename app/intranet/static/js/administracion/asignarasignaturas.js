    ...
    listarasignaturas(){
        let html=`
            <div id="SeleccionarAsignatura">
                    ...
                    <button type="sumbit" class="BotonNormal" onclick="asignarasignaturas.agregarasignaturas()">Agregar Asignatura</button> 
            ...
            <table>
                ...
                ${this.asignaturasprofesor.map(dat=>{
                    ...
                    return `<tr>
                                ...
                                <td><button class="BotonRojo" onclick="asignarasignaturas.quitarasignaturas(${dat.id})">Eliminar</button></td>
                            </tr>
                    `
                }).join("")}
