class javavistacordinador{
    ...
    cargarprofesores(){
      ...
      if($(window).width()<570){
          ...
          <button class="BotonSmall" onclick="vistacordinador.resetearbusqueda()">Borrar Filtro</button>
          <label id="Descargar">Descargar: <input type="checkbox" id="Descargar" onchange="vistacordinador.mostrardatos(false)"></label>
