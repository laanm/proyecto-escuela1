class javapedirsalas{
                                            ...
                                            if(salaspedidasx.idSala.id==salax.id && salaspedidasx.idhorario.id==horariox.id){
                                                ...
                                                if(this.idusuario==salaspedidasx.idProfesor.id){
                                                    if(salaspedidasx.oa==null){
                                                        ...
                                                        <h2 class="Ayuda"><button class="BotonRojo">Eliminar reserva</button></h2>
                                                    `
                                                    }else{
                                                        temp=`<a class="DivPropio" id="${salaspedidasx.id}" info="${salaspedidasx.objetivoAprendizaje}" onclick="pedirsalas.eliminarreserva('${salaspedidasx.id}')" >
                                                        <h2 class="Ayuda"><label class="Descripcion">${salaspedidasx.oa.descripcion}</label><button class="BotonRojo">Eliminar reserva</button></h2>
                                                    `
                                                    }
    ...
    ventanaprofesor(datos,crear){
        let html;
                ...
                html=`
                <button id="Cerrar" onclick="pedirsalas.cerrarventana()">X</button>
                <h1>Reserva Sala</h1>
                

                <div>
                    <p>Tipo de reserva:</p>
                    <p><button class="BotonSmall" id="B-Clase" onclick="pedirsalas.alternartipodereserva(1)">Clase</button><button id="B-Otro" class="BotonSmall" onclick="pedirsalas.alternartipodereserva(2)">Otro</button></p>
                    <p><label>Sala:</label> 
                    <span>
                ...
                <button class="BotonNormal" onclick="pedirsalas.crearpedirsala()">Pedir sala</button>
