class javamiorganigrama{
    ...
    cerrarventana(){
        ...
        this.seleccionados=[]
        this.enseleccion=false
        $(".Seleccionados").removeClass("Seleccionados")
    ...
    abrirventana(){
            ...
            const html=`
                ...
                <div id="Contenido">
                    ...
                    <button class="BotonNormal" onclick="miorganigrama.seleccionardias()">Seleccionar Dias</button>
                    <button class="BotonNormal" id="Agregar" class="CrearPeticion" onclick="miorganigrama.crearevento()">Crear Evento</button>
    ...
    seleccionardias(){
        ...
        if(this.enseleccion==false){
            ...
            $("#Menu2").html(`
                ...
                <button class="BotonNormal" onclick="miorganigrama.seleccionardias()">Terminar Seleccion</button>
            `).css("display","flex")
            $(".BarraSuperior").addClass("Seleccionardias")
            ...
            <button class="BotonNormal" id="BCrear" onclick="miorganigrama.abrirventana()">Crear Evento</button>
            <button class="BotonNormal" id="BCrear" onclick="miorganigrama.cambiardias()">Cambiar Feriados</button>`)
            $(".BarraSuperior").removeClass("Seleccionardias")
        }
    ...
    cambiardias(){
        ...
        if(this.perfil==2){
            temp=`<button class="BotonNormal" id="BCrear" onclick="miorganigrama.abrirventana()">Crear Evento</button>
            <button class="BotonNormal" id="BCrear" onclick="miorganigrama.cambiardias()">Cambiar Feriados</button>`
        }else{
            temp=""
        }
        if(this.enferiados==false){
            $("#Menu2").html(`
            <label>Seleccione los dias para cambiar</label>
            <button class="BotonNormal" onclick="miorganigrama.cambiardias()">Terminar cambios</button>
            `).css("display","flex")
            $(".BarraSuperior").addClass("Seleccionardias")
    ...
    mostrarcalendario()
    {
        ...
        console.log(this.perfil)
        if(this.perfil=="2"){
            temp2=`<button class="BotonNormal" id="BCrear" onclick="miorganigrama.abrirventana()">Crear Evento</button>
            <button class="BotonNormal" id="BCrear" onclick="miorganigrama.cambiardias()">Cambiar Feriados</button>`
        }else{
            temp2=""
        }
        ...
        if(this.calendario.length==0){
            ...
            <div id="Menu">
                <i id="izquierda" class="fa-solid fa-arrow-left fa-2xl"onclick="miorganigrama.cambiarmes(-1)"></i>
                    <h1>${this.quemes(0)}</h1>
                <i id="derecha" class="fa-solid fa-arrow-right fa-2xl"onclick="miorganigrama.cambiarmes(+1)"></i>
                        ...
                        <h2>Eventos del dia</h2>
                            ...
                            ${this.eventos.map(dat=>{
                                if(dat.iddia==x)
                                {
                                    temp3=""
                                    if(this.perfil==2){
                                        temp3=`<button class="BotonRojo" onclick="miorganigrama.eliminarevento(${dat.idevento})">Eliminar</button>`
                                    }
                                    return `
                                    <div class="Item">
                                        <div class="Info"><h4>Titulo</h4><label>${dat.titulo}</label></div>
                                        <div class="InfoDoble"><h4>Hora</h4><label>${dat.hora}</label><h4>accion</h4><label>${temp3}</label></div>
                                        <div class="Des">${dat.descripcion}</div>
                                    </div>
                                    `
                                }
                            }).join("")}
