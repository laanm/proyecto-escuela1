...
class campo_activo(models.Model):
    ...
    fecha_compra = models.DateField(default=None, blank=True, null=True)
    ...
    rut_proveedor = models.CharField(max_length=100, default = "", blank=True, null=True)
...
class metabase(models.Model):
    id = models.AutoField(primary_key=True)
    ruta = models.TextField(default="", blank=True)
