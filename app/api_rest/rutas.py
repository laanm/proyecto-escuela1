...
urlpatterns = [
    ...
    path("devolver_producto",views.devolver_producto.as_view()),

    path("listado_alumnos_year",views.asistencia_lista.as_view()),

    path("listado_alumnos_junaeb", views.listado_alumnos_junaeb.as_view()),
    path("crear_registro_junaeb",views.crear_registro_junaeb.as_view()),
