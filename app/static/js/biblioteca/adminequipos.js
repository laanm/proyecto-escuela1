class javaadminequipos{
            ...
            ${this.productos.map(dat=>{
                ...
                return `
                    <tr>
                        ...
                        <td>${dat.posicion}</td>
                        <td><button onclick="adminequipos.abrircodigo('${dat.codigobarra}',${dat.cantidad})">Ver Codigo</button></td>
                        <td><button class="Eliminar" onclick="adminequipos.eliminarproductocra(${dat.id})">Eliminar</button><button onclick="adminequipos.abrireditarproducto(${dat.id},'${dat.nombre}',${dat.idcategoria.id},${dat.cantidad},'${dat.descripcion}','${dat.posicion}','${dat.codigobarra}')">Editar</button></td>
    ...
    abrireditarproducto(x,nombre,categoria,cantidad,descripcion,posicion,codigo){
        const html=`
        <div id="Contenido">
