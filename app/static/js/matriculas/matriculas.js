...
class javamatriculas{
            ...
            const html=`
                ...
                <div id="Contenido">
                    <div id="MenuContenido">
                        ...
                        <label>Selecciona Curso para ingresar  <select id="CursoObjetivo">
                            ${this.cursos.map(dat=>{
                ...
                <button id="Agregar" class="CrearPeticion" onclick="matriculas.importacionmasiva()">Subida Masiva</button>
                </div>
            `
    ...
    async CargarTablaExcel(){
        ...
        readSheetNames(excel.files[0]).then((nombres)=>{
            console.log(nombres)
        })
