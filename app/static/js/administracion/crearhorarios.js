class javacrearhorarios{
    ...
    creartabla(){
        ...
        let html=`        
            ...
            <button id="CrearPeticion" onclick="crearhorarios.crearventana()">Crear horario</button>
            <button id="CambiarOrden" onclick="crearhorarios.creartablaorden()">Cambiar orden</button>
        <table>
            <tr>
                <th>HoraInicio</th>
                <th>HoraFinal</th>
            ...
            ${this.horarios.map(dat=>{
                return `<tr>
                            ...
                            <td>${dat.horafinal}</td>
                            <td><span><button onclick="crearhorarios.eliminarhorario(${dat.id})">Eliminar</button><button onclick="crearhorarios.ventanaedirhorario(${dat.id},'${dat.horainicio}','${dat.horafinal}')">Editar</button></span></td>
    ...
    creartablaorden(){
        ...
        let html=`        
            ...
            <button id="CambiarOrden" onclick="crearhorarios.cambiarhorario()">Aplicar orden</button>
            <button id="CrearPeticion" onclick="crearhorarios.cargarhorarios()">Cancelar</button>
        <table>
            <tr>
            ...
            ${this.horarios.map((dat,index)=>{
                return `<tr id="H-${dat.id}" class="H">
                            ...
                            <td>${dat.horainicio}</td>
                            <td>${dat.horafinal}</td>
                            <td><span><button onclick="crearhorarios.cambiarorden(${index},true,${dat.id})">Subir</button><button onclick="crearhorarios.cambiarorden(${index},false,${dat.id})">Bajar</button></span></td>
