...
class resumen_data(APIView):
    def get(self, request):
        try:
            ...
            compras['enero'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=1).count()

            compras['febrero'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=2).count()

            compras['marzo'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=3).count()

            compras['abril'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=4).count()

            compras['mayo'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=5).count()

            compras['junio'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=6).count()

            compras['julio'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=7).count()

            compras['agosto'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=8).count()

            compras['septiembre'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=9).count()

            compras['octubre'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=10).count()

            compras['noviembre'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=11).count()

            compras['diciembre'] = campo_activo.objects.filter(fecha_compra__year=year, fecha_compra__month=12).count()
