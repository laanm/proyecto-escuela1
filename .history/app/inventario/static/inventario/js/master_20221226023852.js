        ...
        Swal.fire({
            ...
            width : '70%',
                ...
                if (result.value) {
                    ...
                    if(data.fecha_compra == ""){errores.append("Falta Fecha de Compra")}
                    if(data.descripcion == ""){errores.append("Falta Descripción")}
                    if(data.cantidad == ""){errores.append("Falta Cantidad")}
                    if(data.valor_total == ""){errores.append("Falta Valor Total")}
                    if(data.centro_costo == ""){ errores.append("Falta Centro de Costo")}
                    if(data.nivel_educativo == ""){errores.append("Falta Nivel Educativo")}
                    if(data.grupo == ""){errores.append("Falta Grupo")}
                    if(data.categorizacion == ""){errores.append("Falta Categorización")}
                    if(data.area_asignacion == ""){errores.append("Falta Área de Asignación")}
                    if(data.sala == ""){errores.append("Falta Sala")}
                    if(data.procedencia == ""){errores.append("Falta Procedencia")}
                    if(data.origen_fondo == ""){errores.append("Falta Origen del Fondo")}
                    if(data.estado_conservacion == ""){errores.append("Falta Estado de Conservación")}
                    if(data.inventariable == ""){errores.append("Falta Bien Inventariable")}
