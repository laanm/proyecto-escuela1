class Inventario{
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $this.all_data.familia.push(data[0])
                        $this.cargar_en_select()
                    },
                    error: function (error) {
                        console.log("error",error)
    ...
    crear_grupo(){
        ...
        <div class="swal_form">
            ...
            <div>
                <label>Familia</label>
                <select id="swal_familia">
                    <option value="">Seleccione</option>
                    ${
                        $this.all_data.familia.map((familia) => {
                            return `<option value="${familia.id}">${familia.nombre}</option>`
                        }).join("")
                    }
                </select>
            </div>
